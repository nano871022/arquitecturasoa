 ...
 * @since 20/03/2018
 */
public interface ParametrosSvc {
	/**
	 * Se encarga de crear un parametro
	 * @param paremetro {@link ParametrosToDoDTO}
	 * @throws Exception
	 */
	public void crear(ParametrosToDoDTO paremetro)throws Exception;
	/**
	 * Se encarga de modificar un parametro
	 * @param paremetro {@link ParametrosToDoDTO}
	 * @throws Exception
	 */
	public void modificar(ParametrosToDoDTO paremetro)throws Exception;
	/**
	 * Se encarga de eliminar un parametro siempre y cuando no este usado por otro parametro
	 * @param paremetro {@link ParametrosToDoDTO}
	 * @throws Exception
	 */
	public void eliminar(ParametrosToDoDTO paremetro)throws Exception;
	/**
	 ...
	 * @throws Exception
	 */
	public List<ParametrosToDoDTO> obtener(ParametrosToDoDTO paremetro)throws Exception;
}
